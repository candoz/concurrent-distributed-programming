...
public class MsgDictionary {
    ...
    public final static String REQUEST_TIMEOUT_CRITICAL_SECTION_QUEUE = "request-timeout-critical-section-queue";
    public final static String RESPONSE_QUEUE = "amq.rabbitmq.reply-to";  // DO NOT CHANGE THIS REPRESENTATION!!
